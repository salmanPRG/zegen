  ...
  return (
    <div className="container8">
      <div className="container8-1">
          <div className="card21 col-xl-3 col-lg-3 col-md-4 col-sm-6" >
            <h4>Call Us</h4>
            <div className="dash"></div>
            <p>684 West College St. Sun City, USA.</p>
            <h5>+8 (123) 985 789</h5>
            <span>zegenchurch@mail.com</span>
          </div>
          <div className="discription1 col-lg-4">
            <p>GET IN TOUCH</p>
            <h2>Don't hesitate Contact Us</h2>
            <span>
